#pragma line 1 "VCNN/src/lib/layers/pooling.cpp"
#pragma line 1 "VCNN/src/lib/layers/pooling.cpp" 1
...
#pragma line 1 "VCNN/src/lib/layers/pooling.cpp" 2
...
#pragma line 2 "VCNN/src/lib/layers/pooling.cpp" 2
#pragma line 1 "VCNN/src/lib/layers/../util.h" 1
#pragma line 3 "VCNN/src/lib/layers/pooling.cpp" 2
#pragma line 1 "VCNN/src/lib/layers/../../custom/custom.h" 1
#pragma empty_line
...
#pragma line 3 "VCNN/src/lib/layers/../../custom/custom.h" 2
#pragma empty_line
...
#pragma line 4 "VCNN/src/lib/layers/pooling.cpp" 2
#pragma empty_line
#pragma empty_line
...
#pragma empty_line
 ...
 for (int i = 0; i < ksize; i++)
  ...
  {
   r+=(*(current.input_data + (channel)*(current.input_feature_map_height*current.input_feature_map_width) + (h+i)*current.input_feature_map_width + (w+j)));
  }
 return r/karea;
}
#pragma empty_line
 ...
 for (int c = 0; c < channels; c++)
  for(int h = 0, hc = 0; h < height; h+=stride, hc++)
   for(int w = 0, wc = 0; w < width; w+=stride, wc++)
    {
    *(next.input_data + (c)*(next.input_feature_map_height*next.input_feature_map_width) + (hc)*next.input_feature_map_width + (wc)) = avg(current, ksize, c, h, w);
    }
#pragma empty_line
}
#pragma empty_line
...
class ssdm_global_array_poolingpp0cppaplinecpp {
	public:
		 inline __attribute__((always_inline)) ssdm_global_array_poolingpp0cppaplinecpp() {
...
static ssdm_global_array_poolingpp0cppaplinecpp ssdm_global_array_ins;
