# 1 "C:/VCNN_Update/solution1/.autopilot/db/pooling.pragma.1.cpp"
# 1 "C:/VCNN_Update/solution1/.autopilot/db/pooling.pragma.1.cpp" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 152 "<built-in>" 3
# 1 "<command line>" 1
...
# 9 "<command line>" 2
# 1 "<built-in>" 2
# 1 "C:/VCNN_Update/solution1/.autopilot/db/pooling.pragma.1.cpp" 2
# 1 "VCNN_Update/src/lib/layers/pooling.cpp"
# 1 "VCNN_Update/src/lib/layers/pooling.cpp" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 152 "<built-in>" 3
# 1 "<command line>" 1
