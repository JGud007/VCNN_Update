# 1 "C:/VCNN/solution1/.autopilot/db/custom.pragma.1.cpp"
# 1 "C:/VCNN/solution1/.autopilot/db/custom.pragma.1.cpp" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 152 "<built-in>" 3
# 1 "<command line>" 1
...
# 9 "<command line>" 2
# 1 "<built-in>" 2
# 1 "C:/VCNN/solution1/.autopilot/db/custom.pragma.1.cpp" 2
...
typedef struct {
    int id;
    LayerType type;
# 20 "VCNN/src/custom/caffe_model_layer.h"
