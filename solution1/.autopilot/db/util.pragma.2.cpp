# 1 "C:/VCNN_Update/solution1/.autopilot/db/util.pragma.1.cpp"
# 1 "C:/VCNN_Update/solution1/.autopilot/db/util.pragma.1.cpp" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 152 "<built-in>" 3
# 1 "<command line>" 1
...
# 9 "<command line>" 2
# 1 "<built-in>" 2
# 1 "C:/VCNN_Update/solution1/.autopilot/db/util.pragma.1.cpp" 2
...
# 2 "VCNN_Update/src/lib/util.cpp" 2

float* GET_INPUT_DATA(Layer l, int i, int j, int k, float *layerAddress) {
    return (layerAddress + (i)*(l.input_feature_map_height*l.input_feature_map_width) + (j)*l.input_feature_map_width + (k));
}

class ssdm_global_array_utilpp0cppaplinecpp {
 public:
   inline __attribute__((always_inline)) ssdm_global_array_utilpp0cppaplinecpp() {
...
static ssdm_global_array_utilpp0cppaplinecpp ssdm_global_array_ins;
